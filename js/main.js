...
async function renderHomepageContent() {
    ...
    html += `
        <div class="section-card" id="about">
            ...
            <p class="section-card-description">
                This interactive manual was developed with valuable input and guidance from the JAB Teachers of <a href="https://jcnc.org/jab-program/" target="_blank">JCNC</a> (Jain Center of Northern California).
            </p>
